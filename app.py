...
with gr.Blocks() as demo:
    ...
    gr.HTML("""
    <div id="terms-modal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); z-index: 2000; display: flex; align-items: center; justify-content: center;">
        <div style="background: white; padding: 20px; border-radius: 10px; max-width: 600px; width: 90%; max-height: 80vh; overflow-y: auto; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
            <h2>Terms and Conditions</h2>
            <p>Welcome to the Roulette Spin Analyzer ("the App"), developed for educational and analytical purposes only. By using this App, you agree to the following terms:</p>
            <ol>
                <li><strong>Nature of the App</strong>: This App is designed to analyze roulette spins and provide statistical insights based on user-input data. It is not a gambling tool, nor does it predict future outcomes. Roulette is a game of chance, and no strategy or analysis can guarantee wins.</li>
                <li><strong>Educational Use</strong>: The App is intended for entertainment, learning, and understanding roulette patterns. It is not intended to encourage or facilitate gambling.</li>
                <li><strong>No Liability</strong>: The creators of this App are not responsible for any financial losses, legal issues, or other consequences arising from its use. Users assume full responsibility for their actions.</li>
                <li><strong>No Predictions</strong>: The App does not predict roulette results or offer betting advice. All outputs are based on historical data provided by the user and are for informational purposes only.</li>
                <li><strong>User Agreement</strong>: By clicking "Accept," you confirm that you are of legal age to gamble in your jurisdiction (if applicable) and agree to use this App solely for its intended analytical purpose.</li>
            </ol>
            <p>If you do not agree, please click "Decline" and refrain from using the App.</p>
            <div style="text-align: center; margin-top: 20px;">
                <button id="accept-terms" style="padding: 10px 20px; background-color: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer; margin-right: 10px;">Accept</button>
                <button id="decline-terms" style="padding: 10px 20px; background-color: #dc3545; color: white; border: none; border-radius: 5px; cursor: pointer;">Decline</button>
            </div>
        </div>
    </div>
    """)

    # Wrap the entire app content in a div that starts hidden
    with gr.Group(elem_id="app-content", visible=False):
    ...
    # Add JavaScript to handle the modal and unlock the app
    gr.HTML("""
    <script>
        ...
        // Function to handle decline (e.g., redirect or show message)
        function declineTerms() {
            document.body.innerHTML = '<div style="text-align: center; padding: 50px;"><h1>Access Denied</h1><p>You must accept the Terms and Conditions to use the Roulette Spin Analyzer. Please reload the page to try again.</p></div>';
        }
        ...
        // Ensure app content stays hidden until terms are accepted
        document.getElementById('app-content').style.display = 'none';
    </script>
    """)

    # Update CSS to ensure proper styling
    gr.HTML("""
    ...
    <style>
      ...
      @media (max-width: 600px) {
          ...
          .scrollable-table { max-height: 200upuncture: 100% !important; }
      ...
      /* Ensure app content is hidden by default */
      #app-content {
          display: none;
      }
